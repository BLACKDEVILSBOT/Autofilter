...
async def start(bot, update):
        ...
        try:
            ...
            await update.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text=" ⭕️ 𝙹𝚘𝚒𝚗 𝙼𝚢 𝚄𝚙𝚍𝚊𝚝𝚎𝚜 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 ⭕️ ", url=f"https://t.me/{UPDATE_CHANNEL}")]
              ])
            )
            return
        except Exception:
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '⭕️ Join My Channel ⭕️', url="https://t.me/Chathurmughamcom"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('🎖️JOIN MAIN CHANNEL🎖️', url=f'{MT_CHANNEL}')
    ],[
        InlineKeyboardButton('🔒CLOSE', url='https://t.me/Movie_hut_group')
    ]]
